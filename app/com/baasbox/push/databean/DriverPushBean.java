...
public class DriverPushBean extends PushBean {
     ...
     * @param phoneNumber
     */
    public DriverPushBean(String id, String firstName, LocationBean location, String profilePictureFileId, String rating, String phoneNumber) {
        super();
        this.id = id;
