...
import com.baasbox.service.payment.providers.IPaymentServer;
...
import com.baasbox.service.payment.providers.PaymentProviderAbstract;
...
public class PaymentService {
    ...
    public static IPaymentServer getInstance() {
        return PaymentFactory.getInstance(currentVendor);
    }
...
//    }
    ...
    public static void onBidFailure(String authTransactionId) throws PaymentServerException {
        
        // Void the Authorization transaction
        PaymentService.voidTransaction(authTransactionId);
    }
    
    public static String createTemporaryTransaction(String paymentMethodToken, String amount, String bidId) 
        ...
        return PaymentFactory.getInstance(currentVendor).createTransaction(paymentMethodToken, amountBD, 
                ...
                TEMP_TRANSACTION_DESCRIPTOR_NAME, true, bidId);
    }

    private static String createTransaction(String paymentMethodToken, String amount, String tip, 
            String merchantId, String descriptor, String bidId) 
            throws PaymentServerException {
        ...
        return PaymentFactory.getInstance(currentVendor).createTransaction(paymentMethodToken, 
                amountBD, serviceFeeBD, merchantId, descriptor, false, bidId);
    }
    ...
    public static String cancelTripWithCancellationFees(String authTransactionId, String paymentMethodToken, 
            String cancellationFee, String merchantId, String bidId) throws PaymentServerException {
        
        // Void the Authorization transaction
        PaymentService.voidTransaction(authTransactionId);

        // Create a new transaction with merchant id
        return PaymentService.createTransaction(paymentMethodToken, cancellationFee, 
                "0.0", merchantId, CANCELLATION_FEE_TRANSACTION_DESCRIPTOR_NAME, bidId);
    }
    
    public static String createTransactionAtTripEnd(String authTransactionId, String paymentMethodToken, 
            String amount, String merchantId, String bidId) throws PaymentServerException {
        
        // Void the Authorization transaction
        PaymentService.voidTransaction(authTransactionId);

        // Create a new transaction with merchant id
        return PaymentService.createTransaction(paymentMethodToken, amount, "0.0", 
                merchantId, FARE_TRANSACTION_DESCRIPTOR_NAME, bidId);
    }
    
    public static String createTransactionWithTip(String fareTransactionId, String paymentMethodToken, 
            String amount, String tip, String merchantId, String bidId) throws PaymentServerException {
        
        // Void the Earlier transaction
        PaymentService.voidTransaction(fareTransactionId);
        
        // Create a new transaction with merchant id
        return PaymentService.createTransaction(paymentMethodToken, amount, tip, merchantId, TIP_TRANSACTION_DESCRIPTOR_NAME, bidId);
    }
    
    public static boolean canSettleTransaction(String transactionId) throws PaymentServerException {
        return PaymentFactory.getInstance(currentVendor).canSettleTransaction(transactionId);
    }
...
//    }
//
//    public static boolean canReleaseFromEscrow(String transactionId) throws PaymentServerException {
//        return PaymentFactory.getInstance(currentVendor).canReleaseFromEscrow(transactionId);
//    }
